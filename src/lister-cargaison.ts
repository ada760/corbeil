...
async function remplirTableauCargaisons(cargaisons: any[]) {
...
function creerLigneCargaison(cargaison: any): HTMLElement {
...
function getEtatAvancementClass(etat: string) {
    switch (etat) {
        case "EN_ATTENTE":
            return {
                bg: "bg-gray-600/20",
...
function getEtatGlobalClass(etat: string) {
    switch (etat) {
        case "OUVERT":
            return {
                bg: "bg-cyan-500/20",
...
function getEtatAvancementText(etat: string): string {
    switch (etat) {
...
function getEtatGlobalText(etat: string): string {
    switch (etat) {
